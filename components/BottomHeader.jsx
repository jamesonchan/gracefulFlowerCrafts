    ...
    <div className="sticky top-0 z-50">
      ...
      <div className="shadow-lg bg-white p-2">
        <div className="max-w-7xl xl:mx-auto flex items-center justify-between">
          ...
          {/* search middle */}
          <form className="flex bg-gray-100 border rounded-md mx-5">
            <input
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative flex items-center">
              ...
              <span className="absolute bg-yellow-500 top-0 left-5 w-4 h-4 font-bold rounded-full text-xs text-center  text-white">
                {cart.total_items > 0 ? cart.total_items : 0}
              </span>
            </div>
          </div>
        </div>
